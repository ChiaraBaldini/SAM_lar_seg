...
parser.add_argument('--root_path', type=str,
                    default="/work/cbaldini/medSAM/code/Genova set/train", help='root dir for data')
parser.add_argument('--output', type=str, default='/work/cbaldini/medSAM/code/SAMed/output/sam/results_GENOVA_samedH')
