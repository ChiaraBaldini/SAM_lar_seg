...
from datasets.dataset_laryngoscope import Synapse_dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/work/cbaldini/medSAM/code/laryngoscope_dataset/test', help='root dir for data')
    parser.add_argument('--dataset', type=str, default='Synapse', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=1)
    parser.add_argument('--list_dir', type=str, default='/work/cbaldini/medSAM/code/SAMed/lists/lists_laryngoscope_test', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/work/cbaldini/medSAM/code/SAMed/output/sam/results_laryngoscope_samed39_test')
    ...
    parser.add_argument('--lora_ckpt', type=str, default='/work/cbaldini/medSAM/code/SAMed/output/sam/results_laryngoscope_samed/Synapse_512_pretrain_vit_b_epo100_bs4_lr0.005/epoch_39.pth', help='The checkpoint from LoRA')
    ...
    if args.is_savenii:
        test_save_path = os.path.join(args.output_dir, 'predictions_epoch39')
