...
parser.add_argument(
    ...
    "--data_path",
    type=str,
    default="/work/cbaldini/medSAM/code/MedSAM/assets/img_demo.png",
...
parser.add_argument(
    ...
    "--seg_path",
    type=str,
    default="/work/cbaldini/medSAM/code/MedSAM/assets/",
...
parser.add_argument(
    ...
    "--checkpoint",
    type=str,
    default="/work/cbaldini/medSAM/code/MedSAM/medsam_vit_b.pth",
    help="path to the trained model",
)
parser.add_argument(
    "--txt",
    type=str,
    default="/work/cbaldini/medSAM/code/MedSAM/assets/task2b_93 (2024_05_21 07_46_51 UTC).txt",
...
plt.savefig(os.path.join(args.seg_path, "seg_" + os.path.basename(args.data_path)))
# # plt.show()
