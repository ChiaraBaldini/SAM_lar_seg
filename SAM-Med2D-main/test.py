...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="sammed_GEhenance_noFN", help="run model name")
    parser.add_argument("--batch_size", type=int, default=1, help="batch size")
    parser.add_argument("--image_size", type=int, default=256, help="image_size")
    parser.add_argument('--device', type=str, default='cpu')
    parser.add_argument("--data_path", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/my_data/GE_henance", help="train data path") 
    parser.add_argument("--metrics", nargs='+', default=['iou', 'dice'], help="metrics")
    parser.add_argument("--model_type", type=str, default="vit_b", help="sam model_type")
    parser.add_argument("--sam_checkpoint", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/sam-med2d_b.pth") #/work/cbaldini/medSAM/code/SAM-Med2D-main/workdir/models/sam-med2d/best_model_sam.pth", help="sam checkpoint")
