...
#     parser.add_argument("--work_dir", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/workdir", help="work dir")
#     parser.add_argument("--run_name", type=str, default="sammed", help="run model name")
#     parser.add_argument("--batch_size", type=int, default=1, help="batch size")
#     parser.add_argument("--image_size", type=int, default=256, help="image_size")
#     parser.add_argument('--device', type=str, default='cpu')
#     parser.add_argument("--data_path", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/my_data/SE", help="train data path") 
#     parser.add_argument("--metrics", nargs='+', default=['iou', 'dice'], help="metrics")
#     parser.add_argument("--model_type", type=str, default="vit_b", help="sam model_type")
#     parser.add_argument("--sam_checkpoint", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/workdir/models/sam-med2d/best_model_sam.pth", help="sam checkpoint")
...
#     test_metrics = {}
#     prompt_dict = {}
#     metric_batch_values = [[] for _ in args.metrics]

#     # Initialize a list to store metrics
#     metrics_list = []

#     # Define the path to save the Excel file
#     metrics_file = os.path.join(args.work_dir, args.run_name, "test_metrics.xlsx")

#     # File to save inference times
#     save_path = os.path.join(args.work_dir, args.run_name, "boxes_prompt") if args.boxes_prompt else os.path.join(f"{args.work_dir}", args.run_name, f"iter{args.iter_point if args.iter_point > 1 else args.point_num}_prompt")
#     os.makedirs(save_path, exist_ok=True)
#     time_file = os.path.join(save_path, "inference_times.txt")
...
#             f.write(f"{img_name},{inference_time:.4f}\n")
#         if args.save_pred:
...
#         metrics_list.append({
#             "Image": img_name,
#             **{metric: value for metric, value in zip(args.metrics, test_batch_metrics)}
#         })

#         for j in range(len(args.metrics)):
#             test_iter_metrics[j] += test_batch_metrics[j]
#             metric_batch_values[j].append(test_batch_metrics[j])
...
#     std_metrics = {}
#     for idx, metric_name in enumerate(args.metrics):
#         std_metrics[metric_name] = '{:.4f}'.format(np.std(metric_batch_values[idx]))

#     if args.prompt_path is None:
#         with open(os.path.join(args.work_dir,f'{args.image_size}_prompt.json'), 'w') as f:
#             json.dump(prompt_dict, f, indent=2)
#     print(f"Test loss: {average_loss:.4f} (std: {std_loss:.4f}), metrics: {test_metrics} (std: {std_metrics})")
...
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--work_dir", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/workdir", help="work dir")
    parser.add_argument("--run_name", type=str, default="sammed_testSE", help="run model name")
    parser.add_argument("--batch_size", type=int, default=1, help="batch size")
    parser.add_argument("--image_size", type=int, default=256, help="image_size")
    parser.add_argument('--device', type=str, default='cpu')
    parser.add_argument("--data_path", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/my_data/SE", help="train data path") 
    parser.add_argument("--metrics", nargs='+', default=['iou', 'dice'], help="metrics")
    parser.add_argument("--model_type", type=str, default="vit_b", help="sam model_type")
    parser.add_argument("--sam_checkpoint", type=str, default="/work/cbaldini/medSAM/code/SAM-Med2D-main/sam-med2d_b.pth" ) #/work/cbaldini/medSAM/code/SAM-Med2D-main/workdir/models/sam-med2d/best_model_sam.pth", help="sam checkpoint") #/work/cbaldini/medSAM/code/SAM-Med2D-main/sam-med2d_b_converted.pth")
    parser.add_argument("--boxes_prompt", type=bool, default=True, help="use boxes prompt")
    parser.add_argument("--point_num", type=int, default=1, help="point num")
    parser.add_argument("--iter_point", type=int, default=1, help="iter num") 
    parser.add_argument("--multimask", type=bool, default=True, help="ouput multimask")
