...
def main():
    ...
    parser.add_argument('--sam_ckpt', type=str, default='/work/cbaldini/medSAM/code/sam_vit_b_01ec64.pth', help='Pretrained checkpoint of SAM') # '/work/cbaldini/medSAM/code/sam_vit_b_01ec64.pth', /work/cbaldini/medSAM/code/MedSAM/medsam_vit_b.pth
    ...
    parser.add_argument('--base_lr', type=float, default=0.005, help='segmentation network learning rate, 0.005 for SAMed, 0.0001 for MSA') #0.0006
    ...
    tf_train = JointTransform2D(img_size=args.encoder_input_size, low_img_size=args.low_image_size, ori_size=opt.img_size, crop=opt.crop, p_flip=0.0, p_rota=0.0, p_scale=0.0, p_gaussn=0.0,
                                p_contr=0.0, p_gama=0.0, p_distor=0.0, color_jitter_params=None, long_mask=True)  # image reprocessing
    tf_val = JointTransform2D(img_size=args.encoder_input_size, low_img_size=args.low_image_size, ori_size=opt.img_size, crop=opt.crop, p_flip=0, color_jitter_params=None, long_mask=True)
    ...
    if opt.pre_trained:
        ...
        try:
            ...
            print(f"[WARNING] Partial loading due to: {e}")
